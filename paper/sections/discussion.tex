...
or to open the CRC field to the application level to calculate the MAC. \red{In many systems, the CRC calculation is done in hardware. In such cases, new standardized CAN hardware would be required to use these two extra bytes.}

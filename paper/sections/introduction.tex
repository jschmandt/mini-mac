...
% I would say they took advantage of the fact that there is none by spoofing messages. I don't believe that spoofing authentication specifically was a concern in their work.
...
% What I mean is that the behavior of the ECU does not need to change, the message tranceiver just wraps the message with the Mini-MAC. A change in some of the code would be necessary.

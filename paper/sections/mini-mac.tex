...
%% I have no data on this. I don't have data on how frequently a CAN message fails to send and be received -- we have a similar problem to an attacker in that we don't have a good way of identifying when a message is properly received or not in practice.

...
securely with objects on such networks.
[move to future work.  extra-topical.  relate to paper.  How will our techniques help? (they don't really)  Need
PKI to authenticate messages between cars and signs. I think we should drop all claims that our work is relevant.
Just list as an open problem.]
